export default function Page() {
    ...
    return <div className="bg-gradient-to-l from-purple-500  bg-yellow-300  text-white">
                <nav className=" pt-[30%] flex flex-col justify-center items-center w-screen mb-[100px] ">
                ...
                <ul className="animate-bounce underline text-gry-500 text-2xl font-semibold active:animate-spin trasition-sm">8,5 PUNTOS</ul>
                 ...
                 {/* CURSOS Realizados */}
                 <h1 className="text-white mt-[3%] font-bold italic mb-[15px] text-[20px] text-center ">Cursos Realizados</h1>
                        {/* TARGETA 1 */}
...
{/* imput Cursos Disponibles */}
                <div className=" bg-white w-[230px] h-[55px] z-10 text-white fixed bottom-5 left-[20%] rounded-full">
