...
export default function Page() {
    ...
    const search = async ( email: string )=> {
        const user: any = (await QueryService.query( email ))
        console.log(user)

        const course = (await CourseModel.get( user.courseId ));
        console.log(course)

        setDatas({ user, course });
    }
...
console.log(datas)
    ...
    return <div className="bg-pink-200 sm:h-screen">
        ...
        <div className="flex flex-col justify-center items-center">
            { datas && datas.user?.length && datas.course?.length && (
            ...
            >
                <div className="flex flex-col sm:flex-row sm:justify-between w-full items-center">
                    ...
                    <div className="mb-4 text-center font-mono m-auto">
                        <div className="font-bold">Nombre: Stephany Plaza</div>
                        <div>Edad: 27</div>
                ...
                <div className="mt-5 w-full flex flex-col items-center">
                    ...
                    {/* tecnologias vistas */}
                    <div className="grid sm:grid-cols-3 flex-col justify-center items-center gap-2 text-center m-2 w-full max-w-xs sm:max-w-none sm:flex-row w-full flex-wrap">
